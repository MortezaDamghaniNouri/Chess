...
public class Main {
    ...
    /**
     * it adapts the inputs of the game with a specific formation to the number of the squares of an array.
     *
     * @param choose which piece the user want to move.
     * @param put    the square where the user want to put the piece.
     * @param field  the field of the game.
     * @param turn   it shows that it is white turn or black turn in the game.
     * @return was the movement successful or not.
     */
    ...
    /**
     * it checks if white king piece is at risk or not.
     *
     * @param blackPieces an aaray list of all black pieces in the game.
     * @param field       the field of the game.
     * @return it returns a boolean variable which show that if the black king is at risk or not.
     */
